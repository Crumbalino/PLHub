// ─────────────────────────────────────────────────────────────────
// The Football Hub wordmark. THE ONLY PLACE THE LOGO IS DRAWN.
//
// Every surface imports this component. Nothing else renders the wordmark
// directly — a second copy is how two logos end up shipping at once, and a
// brand swap then misses one of them.
//
// Two tiers:
//
...
export type WordmarkTier = "nav" | "primary";
...
export default function Wordmark({ tier = "nav" }: WordmarkProps) {
