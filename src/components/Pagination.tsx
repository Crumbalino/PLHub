...
export default function Pagination({ currentPage, totalPages, basePath, sortParam }: PaginationProps) {
  ...
  const btnActive =
    'rounded-lg bg-white/5 px-4 py-2 text-sm font-medium text-white/60 transition-colors hover:bg-white/10 hover:text-white'
  const btnDisabled =
    'cursor-not-allowed rounded-lg bg-white/[0.03] px-4 py-2 text-sm font-medium text-white/60'
