...
function NavbarContent() {
  return (
    <nav className="sticky top-0 z-50 bg-[#0B1F21] border-b border-white/5">
      <div className="max-w-[1320px] mx-auto px-4 flex items-center justify-center h-16 relative">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-4xl font-bold text-white tracking-tight">PLhub</span>
        </Link>
        <a
          href="/auth/signin"
