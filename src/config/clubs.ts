...
export const CLUBS: Record<string, Club> = {
  ...
  coventry: {
    ...
    secondaryColour: '#1D1D5F',
    competitions: ['PL'],
    founded: 1883,
    stadium: 'Coventry Building Society Arena',
    city: 'Coventry',
    // Not sourced — see the note in the PR. Renders as an empty
    // "Manager:" line on /clubs/coventry until it is filled in.
    manager: '',
    footballDataId: 1076,
    apiSportsId: 0,
  },
  ...
  hull: {
    ...
    city: 'Hull',
    // Not sourced — see the note in the PR. Renders as an empty
    // "Manager:" line on /clubs/hull until it is filled in.
    manager: '',
    footballDataId: 322,
    apiSportsId: 0,
  },
  ipswich: {
    ...
    city: 'Ipswich',
    manager: "Gary O'Neil",
    // Was 57, which is Arsenal's id — any lookup by it fetched Arsenal.
    footballDataId: 349,
    apiSportsId: 57,
  },
  liverpool: {
  ...
  // Slug is `leeds`, matching src/lib/clubs.ts. It was `leeds-united` here and
  // `leeds` there, so the two registries disagreed on the club's own URL.
  leeds: {
    slug: 'leeds',
