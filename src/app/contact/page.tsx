...
const sections = [
  {
    ...
    body:
      "Please tell me. I'm not precious about it. If something " +
  ...
  },
  {
    ...
    body:
      "The source list is curated and deliberately not exhaustive. If " +
  ...
  },
  {
    ...
    body:
      'Also welcome. PLHub is a living thing. The voice evolves. The ' +
  ...
  },
  {
    ...
    body:
      "Sponsored content. Link insertion. Anyone who has read nothing " +
    ...
    >
      ...
      <div
        style={{
          ...
          border:
            '1px solid color-mix(in srgb, var(--plh-teal) 20%, transparent)',
          borderRadius: '8px',
        }}
      >
        <p
