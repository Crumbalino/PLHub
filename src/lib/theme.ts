...
const sourceColors: Record<string, { dark: string; light: string }> = {
  ...
  'The Guardian':  { dark: '#6B9E78', light: '#4A7A58' },
  'Guardian':      { dark: '#6B9E78', light: '#4A7A58' },
  ...
  'The Independent': { dark: '#8B5CF6',   light: '#7C3AED' },
  'ESPN FC':       { dark: '#CC0000',     light: '#B30000' },
  'ESPN.com':      { dark: colors.pink,   light: colors.pink },
